...
Feature: Validating pizza application functionalities
  ...
  Scenario Outline: Validating place order functionality
    ...
    Examples:
      ...
      | Large 10 Slices - 2 toppings | Mushrooms  | Extra cheese | 3        | Patel Harsh | patel@gmail.com   | 123456789 | Credit Card    |
      | Medium 8 Slices - 2 toppings | Olives     | Salami       | 2        | Kim Moore   | kim@gmail.com     | 123456789 | Cash on Pickup |